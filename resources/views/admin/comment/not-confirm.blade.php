...
@section('sub_title_page', 'Bình luận chưa xác nhận')

@section('content_page')
<div class="card-header">Danh sách bình luận chưa xác nhận</div>
<div class="table-responsive" style="padding-bottom: 10px;">
    ...
    @else
    <div class="text-center text-noti">Không có bình luận nào chưa xác nhận để hiển thị</div>
    @endif
</div>
@endsection
