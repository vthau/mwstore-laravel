...
@section('title_page', 'Chỉnh sửa vai trò')
@section('sub_title_page', 'Chỉnh sửa vai trò')
...
<div class="card-body">
    <h5 class="card-title">Chỉnh sửa vai trò</h5>
    <form class="needs-validation" action="{{route('role.update', $role->id)}}" method="POST" enctype="multipart/form-data" novalidate>
        @csrf
        @method('PUT')
        <div class="form-row">
            <div class="col-md-6 mb-3">
                <label for="validationTooltip01">Tên vai trò</label>
                <input type="text" class="form-control" id="validationTooltip01" name="name" placeholder="Tên vai trò" value="{{$role->name}}" required>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="validationTooltip03" name="description" placeholder="Mô tả" value="{{$role->description}}" required>
                <div class="invalid-feedback">Vui lòng nhập đầy đủ dữ liệu.</div>
                            ...
                            <div class="widget-content-wrapper">
                                ...
                                <div class="widget-content-right">
                                    <div class="widget-numbers text-success">
                                        <input type="checkbox" class="checkbox-childrent" name="permission_id[]" {{$permission_admin->contains('id', $permission->id) ? 'checked' : '' }} value="{{$permission->id}}" />
                                    </div>
                                </div>
                            </div>
                        </div>
