          ...
          <div class="box-chat">
              <div class="header-chat">
                  ...
                  <div class="header-chat-info">
                      ...
                      <p class="status">@lang('lang.care_user')</p>
                  </div>
              ...
              <div class="footer-chat">
                  ...
                  <div class="footer-chat-message">
                      <input type="text" class="message-content" placeholder="@lang('lang.input_message')..." />
                  </div>
      ...
      <script src="{{asset('users/js/jquery.lazy.min.js')}}"></script>
      <script src="{{asset('users/js/jquery.lazy.plugins.min.js')}}"></script>
      <script>
          $(function() {
              $('.lazy').lazy({
                  effect: "fadeIn",
      ...
      <script src="{{asset('users/js/modernizr-3.5.0.min.js')}}"></script>
      <!-- jquery 3.2.1 -->
      <!-- Countdown js -->
      <script src="{{asset('users/js/jquery.countdown.min.js')}}"></script>
      <!-- Mobile menu js -->
      <script src="{{asset('users/js/jquery.meanmenu.min.js')}}"></script>
      <!-- ScrollUp js -->
      <script src="{{asset('users/js/jquery.scrollUp.js')}}"></script>
      <!-- Nivo slider js -->
      <script src="{{asset('users/js/jquery.nivo.slider.js')}}"></script>
      <!-- Fancybox js -->
      ...
      <!-- Main activaion js -->
      <script src="{{asset('users/js/elevatezoom.js')}}"></script>
      <script src="{{asset('users/js/main.js')}}"></script>
      <script src="{{asset('users/js/toastr.min.js')}}"></script>
      <script src="{{asset('users/js/validate.js')}}"></script>
      ...
      <script>
          toastr["success"]("@lang('lang.signup_success')", "@lang('lang.success') !!!");
      </script>
      @endif

      <script src="{{asset('users/js/custom-script.js')}}"></script>
