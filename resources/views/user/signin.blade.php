    ...
    <div class="container">
        <div class="forms-container">
            <div class="signin-signup">
                <form action="{{route('user.signin_post')}}" method="POST" class="sign-in-form">
                    @csrf
                    ...
                    <div class="input-field">
                        ...
                        <input type="password" name="password" value="{{ old('password') }}" placeholder="Nhập password..." required />
                    </div>
                    ...
                    <a href="{{route('user.forgot_password')}}" class="forget-password">Quên mật khẩu ?</a>
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    ...
                    <a href="{{route('user.signup_get')}}" class="btn transparent">
                        Đăng ký
                    </a>
                </div>
                <img src="{{asset('users/img/log.svg')}}" class="image" alt="" />
            </div>
        </div>
    </div>
</body>
